...
using BuilderImplementation.Builders.PredifinedSequence;
using BuilderImplementation.Builders.RegularBuilder;
using BuilderImplementation.Car;
using CarRegularBuilder = BuilderImplementation.Builders.RegularBuilder.CarBuilder;
using System;
...
namespace Sandbox
{
    class Program
    {
        ...
        {
            CarRegularBuilder carBuilder = new SportCoupeBuilder();
            ...
            ICarBuilder sequencialCarBuilder = new SequencialCarBuilder();
